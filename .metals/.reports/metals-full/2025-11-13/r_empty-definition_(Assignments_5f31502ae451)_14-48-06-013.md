file://<WORKSPACE>/Day7/Tasks/Question2.scala
...
non-local guesses:
	 ...
	 -scala/Predef.println().
offset: 481
uri: file://<WORKSPACE>/Day7/Tasks/Question2.scala
text:
```scala
trait Device {
...
trait EnergySaver {
  ...
  def turnOff(): Unit = {p@@rintln("Device powered down to save energy"
  )}
}
...
class SmartLight extends Device with Connectivity with EnergySaver {
  ...
  override def turnOff(): Unit = println("SmartLight turned off")
}
