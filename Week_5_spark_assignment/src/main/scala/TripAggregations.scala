...
object TripAggregations {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val df = spark.read.parquet(
      "/Users/racit/Documents/SPARK/spark-examples-main/trips_with_duration_parquet"
    )
    ...
    avgDistanceByVehicle.write.mode("overwrite")
      .parquet("/Users/racit/Documents/SPARK/spark-examples-main/aggregate_pipeline/agg_avg_distance_by_vehicle")

    revenueByDay.write.mode("overwrite")
      .parquet("/Users/racit/Documents/SPARK/spark-examples-main/aggregate_pipeline/agg_revenue_by_day")

    topRoutes.write.mode("overwrite")
      .parquet("/Users/racit/Documents/SPARK/spark-examples-main/aggregate_pipeline/agg_top_routes")
