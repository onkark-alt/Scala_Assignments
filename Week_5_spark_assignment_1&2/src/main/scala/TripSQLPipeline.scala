...
object TripSQLPipeline {
  ...
  def main(args: Array[String]): Unit = {
    ...
    sql1.write.mode("overwrite")
      .parquet("/Users/racit/Documents/SPARK/spark-examples-main/sql_pipeline/sql_vehicleType_count")

    sql2.write.mode("overwrite")
      .parquet("/Users/racit/Documents/SPARK/spark-examples-main/sql_pipeline/sql_avg_fare_by_route")

    sql3.write.mode("overwrite")
      .parquet("/Users/racit/Documents/SPARK/spark-examples-main/sql_pipeline/sql_payment_method_count")
